...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap"
          rel="stylesheet">
    <title>View your basalt info!</title>
</head>
...
<div class="mt-4 mb-6">
    ...
    <h1 class="font-bold text-2xl mb-2">Basalt</h1>
    <span class="line-w bg-green h-0.5 block self-center "></span>
</div>
<div class="grid grid-cols-2 grid-rows-2 justify-items-stretch">
...
<div class="w-full glassmorphism mt-8">
        <div class="flex flex-row items-center mt-3">
            <svg class="ml-5 mr-5" xmlns="http://www.w3.org/2000/svg" width="30" height="35" viewBox="0 0 24 29">
                <defs>
                    <style>
                        .cls-1 {
                            fill: #f8f8ff;
            ...
            <h2 class="font-medium text-2xl">Your battery info</h2>
        </div>
    <div class="flex flex-col items-end mt-0.5">
        <span class="line-w2 bg-red h-0.5 block self-right"></span>
    </div>
    <div class="grid grid-cols-2 grid-rows-2 mt-2 pl-5 pr-5 justify-items-stretch">
        <p class="col-start-1 col-end-3 row-start-1 row-end-2 justify-self-start text-white font-medium text-base">Available to charge up</p>
        <p class="col-start-2 col-end-3 row-start-1 row-end-2 justify-self-end text-white font-medium text-base">15% / 100%</p>
        <div class="w-full bg-white col-start-1 col-end-3 row-start-2 row-end-3 h-2 rounded-full mt-2">
            <div class="w-3/4 bg-green h-2 rounded-full"></div>
        </div>
    </div>
    <div class="grid grid-cols-2 grid-rows-2 mt-2 pl-5 pr-5 justify-items-stretch mb-2">
        <p class="col-start-1 col-end-3 row-start-1 row-end-2 justify-self-start text-white font-medium text-base">Current energy stored</p>
        <p class="col-start-2 col-end-3 row-start-1 row-end-2 justify-self-end text-white font-medium text-base">2.5% / 15%</p>
        <div class="w-full bg-white col-start-1 col-end-3 row-start-2 row-end-3 h-2 rounded-full mt-2">
            <div class="w-3/4 bg-green h-2 rounded-full"></div>
        </div>
    </div>
...
<div class="w-full glassmorphism mt-8">
    <div class="flex flex-row items-center mt-3">
        <svg class="ml-5 mr-5" id="statistics"
             xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 111 111">
            <defs>
                <style>
                    .cls-1 {
                        fill: #f8f8ff;
        ...
        <h2 class="font-medium text-2xl">Want to charge up?</h2>
    </div>

    <div class="flex flex-col items-end mt-0.5">
        <span class="line-w2 bg-green h-0.5 block self-right"></span>
    </div>
    <div class="flex flex-col items-center mt-2 px-4">
        <p class="text-white font-medium text-base mb-4 text-center">Average energy generation today: <br><span class="text-green text-2xl">7.6 kWh</span></p>
        <div class="bg-white rounded-full w-full flex flex-row justify-between p-1 mb-4">
            <button class="bg-green rounded-full px-4 text-white font-medium text-base">CHARGE</button>
            <button class="rounded-full text-black font-medium text-base">CONSUME</button>
            <button class="rounded-full text-black font-medium text-base mr-4">BALANCED</button>
        </div>
        <div class="w-full bg-green col-start-1 col-end-3 row-start-2 row-end-3 h-2 rounded-full">
            <div class="w-3/4 bg-green h-2 rounded-full"></div>
        </div>
        <p class="font-base text-white text-center my-2">100% of the generated energy will be used to charge up the battery.</p>
    </div>
